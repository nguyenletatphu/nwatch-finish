...
function buyButtonClicked() {
    alert("Sản phẩm của bạn đã được đặt");
...
function updatetotal() {
    ...
    for (var i= 0; i < cartBoxes.length; i++) {
        ...
        document.getElementsByClassName("total-price")[0].innerHTML= total+"đ";
...
toggleDark.onclick = function() {
    ...
    if(document.body.classList.contains("dark")){
        toggleDark.src = "image/sun.png";
    }
    else {
         toggleDark.src = "image/moon.png";
    }
}
